...
# env_str = 'MiniGrid-Dynamic-Obstacles-5x5-v0'
env_str = 'MiniGrid-Dynamic-Obstacles-Random-6x6-v0'

load_model_str = 'MiniGrid-Dynamic-Obstacles-5x5-v0'
...
model.learn(total_timesteps=int(3e6), reset_num_timesteps=(False)) #500k steps
# Save the agent
