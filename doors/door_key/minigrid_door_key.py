...
# Create environment
# base model --> minigrid empty random 6x6
# 1st train --> MiniGrid-DoorKey-6x6-v0
# 2nd train --> MiniGrid-DoorKey-8x8-v0
# 3rd train --> 'MiniGrid-DoorKey-16x16-v0'

env_str = 'MiniGrid-DoorKey-16x16-v0'
load_model_str = 'MiniGrid-DoorKey-8x8-v0'
